...
public class addressTest {
	...
	public void testGetStreet(){
		try {
			Address address = new Address("Bank","Ottawa","K1S 2R2");
	...
	public void testGetPostalCode(){
		try {
			Address address = new Address("Bank","Ottawa","K1S 2R2");
			assertTrue(address.getPostalCode().equals("K1S 2R2"));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void testSetPostalCode(){
		try {
			Address address = new Address("Bank","Ottawa","K1S 2R2");
			address.setPostalCode("K1S 2R4");
			assertTrue(address.getPostalCode().equals("K1S 2R4")); 
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
